 ...
 * Datasets - Featured
 */
export const GET_FEATURED_DATASETS_SUCCESS = 'datasets/GET_FEATURED_DATASETS_SUCCESS';
export const GET_FEATURED_DATASETS_ERROR = 'datasets/GET_FEATURED_DATASETS_ERROR';
export const GET_FEATURED_DATASETS_LOADING = 'datasets/GET_FEATURED_DATASETS_LOADING';
/**
 * Selected Dataset
 */
